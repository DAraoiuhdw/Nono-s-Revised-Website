...
export const categories = [
  "All","Breakfast","Starters","Salads","Fried Chicken","Mains","Pasta","Pizza","Sandwiches","Kids","Afternoon",
] as const;
...
export const menuItems: MenuItem[] = [
  // BREAKFAST
  { name: "Waffles Benedict", category: "Breakfast", description: "Crispy Belgian waffles topped with poached eggs, Canadian bacon, and velvety hollandaise sauce.", price: 465, image: "https://images.unsplash.com/photo-1562376552-0d160a2f238d?w=600&q=80" },
  ...
  { name: "Steak & Eggs", category: "Breakfast", description: "Premium grilled steak served with eggs cooked your way and crispy hash browns.", price: 1195, image: "https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=600&q=80" },
  ...
  { name: "Parmesan Truffle Fries", category: "Starters", description: "Hand-cut fries tossed in truffle oil, grated Parmesan, and fresh parsley.", price: 345, image: "https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=600&q=80" },
  ...
  // FRIED CHICKEN
  { name: "Nono's Homestyle Fried Chicken", category: "Fried Chicken", description: "Our signature crispy fried chicken, seasoned with a treasured family blend of herbs and spices.", price: 555, image: "https://images.unsplash.com/photo-1626645738196-c2a7c87a8f58?w=600&q=80" },
  ...
  // MAINS
  { name: "Nono's Pork Belly Sisig", category: "Mains", description: "Sizzling crispy pork belly sisig with egg, calamansi, and chili on a hot plate.", price: 545, image: "https://images.unsplash.com/photo-1625938145744-e380515399bf?w=600&q=80" },
  ...
  { name: "Truffle Roast Beef", category: "Mains", description: "Slow-roasted prime beef infused with black truffle, served with rich truffle jus.", price: 1195, image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=80" },
  ...
  { name: "Baby Back Ribs", category: "Mains", description: "Fall-off-the-bone tender ribs glazed with our house-made smoky barbecue sauce.", price: 895, image: "https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?w=600&q=80" },
  ...
  { name: "Salmon with Hollandaise", category: "Mains", description: "Pan-seared salmon with golden crust, draped in hollandaise with asparagus.", price: 795, image: "https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=600&q=80" },
  ...
  { name: "Mac N Cheese", category: "Pasta", description: "Classic baked macaroni and cheese with a crispy breadcrumb and Gruyère crust.", price: 555, image: "https://images.unsplash.com/photo-1543339494-b4cd4f7ba686?w=600&q=80" },
  { name: "My Mom's Baked Spaghetti", category: "Pasta", description: "Homestyle baked spaghetti with a rich meat sauce, topped with melted mozzarella.", price: 495, image: "https://images.unsplash.com/photo-1595295333158-4742f28fbd85?w=600&q=80" },
  ...
  { name: "Nono's Pizza", category: "Pizza", description: "Our signature pizza with Italian sausage, roasted peppers, onions, and artisanal cheeses.", price: 645, image: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=600&q=80" },
  ...
  // SANDWICHES
  { name: "Nono's Burger", category: "Sandwiches", description: "House-ground beef patty with lettuce, tomato, special sauce on a toasted brioche bun.", price: 465, image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=80" },
